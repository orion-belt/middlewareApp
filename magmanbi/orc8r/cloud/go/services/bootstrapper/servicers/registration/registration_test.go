...
import (
	...
	"middlewareApp/magmanbi/orc8r/cloud/go/services/bootstrapper/servicers/registration"
	...
	tenant_TestInit "middlewareApp/magmanbi/orc8r/cloud/go/services/tenants/test_init"
