...
import (
	...
	//protos "middlewareApp/magmanbi/orc8r/lib/go/protos"
	reflect "reflect"
)
...
func (*UnimplementedStreamProviderServer) GetUpdates(context.Context, *StreamRequest) (*DataUpdateBatch, error) {
